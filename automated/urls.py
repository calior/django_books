...
from autoplat.admin import admin as autoAdmin
from books.admin import admin as bookAdmin
...
urlpatterns = [
    ...
    # url(r'^admin/', include(autoAdmin.site.urls)),
    ...
    url(r'^book/test/$', book.test),
    url(r'^book/booklist/$', book.book_list),
    url(r'^book/admin/', include(bookAdmin.site.urls)),
    url(r'^book/formtest/', book.form_test),
    url(r'^book/search/$', book.search),
    url(r'^book/contact/$', book.contact),
    url(r'^book/contact/thanks/$', book.thanks)
]
